...
export class UserAnswerController {
  constructor(private readonly userAnswerService = new UserAnswerService()) {}
  ...
  public listByAttempt = async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  public create = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { userId, userQuizId, questionId, answerId } = req.body as {
        userId?: unknown;
        userQuizId?: unknown;
        questionId?: unknown;
        answerId?: unknown;
